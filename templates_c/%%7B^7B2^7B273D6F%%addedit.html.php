...
?>
					<option value='<?php echo $this->_tpl_vars['projects'][$this->_sections['i']['index']]['id']; ?>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
					<option value='<?php echo $this->_tpl_vars['categories'][$this->_sections['i']['index']]['id']; ?>
'><?php echo $this->_tpl_vars['categories'][$this->_sections['i']['index']]['label']; ?>
</option>
				<?php endfor; endif; ?>
			</select>
