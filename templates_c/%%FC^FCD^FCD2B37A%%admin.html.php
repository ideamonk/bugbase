<?php /* Smarty version 2.6.26, created on 2010-04-26 03:12:02
...
">del</a></span> </p>
			<?php endfor; endif; ?>
			<div>
				<form action='/index.php?page=addCat' method='post'>
					<input type='text' name='label'/>
					<button type='submit'>+</button>
				</form>
			</div>
...
">del</a></span> </p>
			<?php endfor; endif; ?>
			<div>
				<form action='/index.php?page=addPri' method='post'>
					<input type='text' name='label'/>
					<button type='submit'>+</button>
				</form>
			</div>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
			<?php if ($this->_tpl_vars['users'][$this->_sections['i']['index']]['is_admin'] != '1'): ?>
