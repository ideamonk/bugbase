<?php /* Smarty version 2.6.26, created on 2010-05-01 10:22:00
...
<div id='contentSpacer'>
    <div id='leftBox'>
        <div class='welcomeReport'>
            ...
            <p class='userWork'>
                Currently, you're working on <a href='/index.php?page=list&filter=self_working'><?php echo $this->_tpl_vars['my_active_count']; ?>
</a> bugs.
            </p>
            <p class='userClose'>
...
">
							...
							</a> <?php if (( $this->_tpl_vars['bugsToday'][$this->_sections['i']['index']]['comment'] == '' )): ?>created<?php endif; ?> by <span class='bluebox'><small><?php echo $this->_tpl_vars['bugsToday'][$this->_sections['i']['index']]['addedBy']; ?>
</small></span>
...
">
							...
							</a> <?php if (( $this->_tpl_vars['bugsOld'][$this->_sections['i']['index']]['comment'] == '' )): ?>created<?php endif; ?> by <span class='bluebox'><small><?php echo $this->_tpl_vars['bugsOld'][$this->_sections['i']['index']]['addedBy']; ?>
</small></span>
